                      ...
                      <div class="entry-header">
                        ...
                        <div class="entry-meta">
                          <span class="posted-on">
                            on <a href="single.html" rel="bookmark"> <time class="entry-date" datetime="2016-09-07">Sept 07, 2016</time> </a>
                          </span><!-- .posted-on -->
                          <span class="entry-comment">
                            with <span class="comment-link"><a href="#comments">4 Comments</a></span>
                          </span><!-- .entry-cat -->
                          <span class="entry-cat">
                            in <span class="cat-link"><a href="category.html">Tips</a></span>
                          </span><!-- .entry-cat -->
